...
// The time complexity is often represented as O(b^d), where 'b' is the average branching factor 
// and 'd' is the depth of the shallowest goal node. In the case of the 8-puzzle problem, 'b' 
// is relatively small 
// (typically less than 4), and 'd' varies depending on the specific instance of the problem.
